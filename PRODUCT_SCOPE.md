...
12. `media_stack_start`: inicio del stack multimedia en background.
13. `media_stack_status`: consulta de estado del stack multimedia.
14. `media_stack_stop`: apagado del stack multimedia.
15. `movie_search_radarr`: búsqueda de películas en Radarr para flujo web/desktop.
